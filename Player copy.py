...
class Player:
    def __init__(self):
        ...
        self.attackDamage = 4
        #self.weapons = "Pocket Knife"
        self.bag = [ 0 for i in range(10) ]  #[ torch, matches, pocketKnife ]
    ...
    def left(self, movement):
        ...
        if not validMove:
            ...
            if len(intersectionPoints) != 0:
                ...
                if tayK.lower() == "yes":
                    soulja = int(input(
                        "What intersection point do you want to go to (Enter 1 or {}): ".format(len(intersectionPoints))))

                    while soulja < 1 or soulja > len(intersectionPoints):
                        soulja = int(input("Please enter a valid option:"))

                    self.userCoordinates = intersectionPoints[soulja - 1].copy()
    ...
    def right(self, movement):
        ...
        if not validMove:
            ...
            if len(intersectionPoints) != 0:
                ...
                if tayK.lower() == "yes":
                    soulja = int(input("What intersection point do you want to go to (Enter 1 or {}): ".format(len(intersectionPoints)), ))
